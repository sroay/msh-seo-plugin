...
// Core sitemaps are switched off in MSH_SEO_Sitemap::init(), only when MSH SEO
// serves its own. Switching them off here as well left a site that runs another
// SEO plugin without the core sitemap whenever that plugin relies on it.
